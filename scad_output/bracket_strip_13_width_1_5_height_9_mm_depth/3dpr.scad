...
difference() {
	union() {
		hull() {
			translate(v = [-92.0000000000, 5.7500000000, 0]) {
				cylinder(h = 9, r = 5);
			}
			translate(v = [92.0000000000, 5.7500000000, 0]) {
				cylinder(h = 9, r = 5);
