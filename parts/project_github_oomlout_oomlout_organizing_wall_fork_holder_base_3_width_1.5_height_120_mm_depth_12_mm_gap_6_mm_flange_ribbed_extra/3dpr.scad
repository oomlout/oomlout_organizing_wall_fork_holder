...
difference() {
	union() {
		...
		translate(v = [13.0000000000, 0, 122.0000000000]) {
			cylinder(h = 6, r = 7.0000000000);
		}
		translate(v = [-13.0000000000, 0, 122.0000000000]) {
			cylinder(h = 6, r = 7.0000000000);
		}
		translate(v = [13.0000000000, 0, 119.0000000000]) {
	...
	union() {
		...
		translate(v = [13.0000000000, 0, 125]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
		...
		translate(v = [13.0000000000, 0, 104.0000000000]) {
			rotate_extrude(angle = 360) {
				translate(v = [12.0000000000, 0, 0]) {
					circle(r = 5.0000000000);
				}
		...
		translate(v = [13.0000000000, 0, 114.0000000000]) {
			rotate_extrude(angle = 360) {
				translate(v = [12.0000000000, 0, 0]) {
					circle(r = 5.0000000000);
				}
